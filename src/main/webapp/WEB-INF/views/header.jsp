            ...
            <div class="spark-menu spark-header__menu" role="menu">
               ...
               <ul class="spark-menu__list spark-header__list spark-header__list--overflow">
                  <li class="spark-menu__list-item" role="menuitem">
                           ...
                           <a href="#" class="spark-menu__list-link">Participants</a>
                  ...
                  <li class="spark-menu__list-item" role="menuitem">
                           <span class="spark-menu__list-links">
                           <a href="#" class="spark-menu__list-link">Asset</a>
                           <button class="spark-menu__list-expand" role="menuitemcheckbox" title="Expand"></button>
                           </span>
                     <ul class="spark-menu__list">
                        <li class="spark-menu__list-item" role="menuitem">
                           <a href="aircraft" class="spark-menu__list-link">Aircraft Component</a>
                        </li>
                     </ul>
                  </li>
                  <li class="spark-menu__list-item" role="menuitem">
                           <span class="spark-menu__list-links">
                           <a href="#" class="spark-menu__list-link">Transactions</a>
                           <button class="spark-menu__list-expand" role="menuitemcheckbox" title="Expand"></button>
                           </span>
                     <ul class="spark-menu__list">
                        <li class="spark-menu__list-item" role="menuitem">
                  ...
                  <li class="spark-menu__list-item" role="menuitem">
                     <a href="transactionHistory" class="spark-menu__list-link">Transactions History</a>
                  </li>
               </ul>
            </div>
         </nav>
