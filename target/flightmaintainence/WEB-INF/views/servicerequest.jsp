    ...
    <div class="container container-spacing">
        ...
        <div class="sb-pad-0 col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <section>
                ...
                <div class="spark-select-group spark-margin-top">
                    <label class="spark-select">
                        <select name="nextServiceMonth" class="spark-select__input">
                            <option></option>
                            <option>Jan</option>
                            <option>Feb</option>
                            <option>Mar</option>
                    ...
                    <label class="spark-select">
                        <select name="nextServiceDay" class="spark-select__input">
                            <option></option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                    ...
                    <label class="spark-select">
                        <select name="nextServiceYear" class="spark-select__input">
                            <option></option>
                            <option>1967</option>
                            <option>1968</option>
                            <option>1969</option>
